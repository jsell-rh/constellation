...
async function testMCPAuth() {
  ...
  try {
    const response1 = await axios.post(MCP_URL, {
      jsonrpc: '2.0',
      method: 'tools/call',
      params: {
        name: 'query',
  ...
  try {
    const response2 = await axios.post(MCP_URL, {
      jsonrpc: '2.0',
      method: 'tools/call',
      params: {
        name: 'query',
  ...
  try {
    const response3 = await axios.post(MCP_URL, {
      jsonrpc: '2.0',
      method: 'tools/call',
      params: {
  ...
  try {
    const response4 = await axios.post(MCP_URL, {
      jsonrpc: '2.0',
      method: 'tools/call',
      params: {
